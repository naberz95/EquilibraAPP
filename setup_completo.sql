-- PASO 1: CREAR DATOS BÁSICOS NECESARIOS PARA CITAS

-- 1. ENTIDAD (necesaria para pacientes y planes)
INSERT INTO entidades (nombre_entidad, created_at, updated_at) VALUES 
('Clínica de Prueba', NOW(), NOW());

-- 2. ROL (necesario para usuarios)
INSERT INTO roles (nombre_rol, created_at, updated_at) VALUES 
('psicologo', NOW(), NOW());

-- 3. USUARIOS (necesarios para psicólogos)
INSERT INTO usuarios (nombre, apellido, email, contraseña, rol_id, estado, created_at, updated_at) VALUES 
('Ana', 'García', 'ana.garcia@equilibrapp.com', '$2y$12$LQv3c1yMonGmALWaT6jMLOyqanFZfth4NLqAxCOuiui7lNBRBqAyS', 1, 'activo', NOW(), NOW()),
('Carlos', 'López', 'carlos.lopez@equilibrapp.com', '$2y$12$LQv3c1yMonGmALWaT6jMLOyqanFZfth4NLqAxCOuiui7lNBRBqAyS', 1, 'activo', NOW(), NOW());
