<div class="paciente-create-section paciente-create-container">
    ...
    <div class="form-container">
        <form action="{{ route('pacientes.store') }}" method="POST" onsubmit="handlePacienteForm(event, this)">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('lugar_nacimiento') is-invalid @enderror" 
                               id="lugar_nacimiento" name="lugar_nacimiento" value="{{ old('lugar_nacimiento') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('fecha_registro') is-invalid @enderror" 
                               id="fecha_registro" name="fecha_registro" value="{{ old('fecha_registro', date('Y-m-d')) }}" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('barrio_residencia') is-invalid @enderror" 
                               id="barrio_residencia" name="barrio_residencia" value="{{ old('barrio_residencia') }}" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('acudiente_nombre') is-invalid @enderror" 
                               id="acudiente_nombre" name="acudiente_nombre" value="{{ old('acudiente_nombre') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="tel" class="form-control @error('acudiente_telefono') is-invalid @enderror" 
                               id="acudiente_telefono" name="acudiente_telefono" value="{{ old('acudiente_telefono') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('entidad_id') is-invalid @enderror" id="entidad_id" name="entidad_id" required>
                            ...
                            @foreach($entidades as $entidad)
                                <option value="{{ $entidad->id_entidad }}" {{ old('entidad_id') == $entidad->id_entidad ? 'selected' : '' }}>
